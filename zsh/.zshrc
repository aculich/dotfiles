...
plugins=(jq zsh-smart-insert git aliases alias-finder docker mix macos python asdf direnv zsh-autosuggestions zsh-completions) # zsh-more-completions)
#plugins=(gcom jq git docker mix macos python asdf direnv zsh-autosuggestions) # zsh-completions) # zsh-more-completions)
...
#
## Load the select-word-style function
#autoload -U select-word-style
#
## Set the word style to Bash
##select-word-style bash
#
## Alternatively, set the word style to Default
...
eval 
SF_AC_ZSH_SETUP_PATH=/Users/me/Library/Caches/sf/autocomplete/zsh_setup && test -f $SF_AC_ZSH_SETUP_PATH && source $SF_AC_ZSH_SETUP_PATH; # sf autocomplete setupexport PATH="/opt/homebrew/opt/openjdk@21/bin:$PATH"
...
# Prioritize Homebrew's Node.js version over nvm
export PATH="/opt/homebrew/bin:/opt/homebrew/sbin:$PATH"

# Created by `pipx` on 2024-07-30 16:14:59
