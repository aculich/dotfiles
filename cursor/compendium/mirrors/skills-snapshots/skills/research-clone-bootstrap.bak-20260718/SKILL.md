...
description: >-
  ...
  clones never pollute product indexing. Use for /research-clone-bootstrap.
...
```bash
~/.cursor/skills/research-clone-bootstrap/scripts/bootstrap.sh \
  'https://www.raycast.com/' --slug raycast
```
...
- Reference Jumpkey: `macosx-tools/research-clones/` + `apps/jumpkey/research/`.
...
- Jumpkey living example — dual workspace + matrix + peers clones
